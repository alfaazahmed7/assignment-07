    ...
    return (
        <div className='w-9/12 mx-auto'>
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-5'>
                <div className='bg-white p-5 lg:p-10 rounded-md shadow-md text-center flex flex-col justify-center transition-transform duration-300 ease-in-out hover:scale-103'>
                    <h4 className='text-3xl font-bold text-[#131313]'>20</h4>
                    <p className='text-base text-[#64748B]'>Total Friends</p>
                </div>
                <div className='bg-white p-10 rounded-md shadow-md text-center flex flex-col justify-center transition-transform duration-300 ease-in-out hover:scale-103'>
